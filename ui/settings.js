// The Settings section of the one window. Vanilla JS, no bundler, no
// framework. Wrapped in an IIFE and scoped to its own section, because
// review.js and app.js share the page: a second top level
// `const { invoke }` would be a redeclaration error.
(() => {
