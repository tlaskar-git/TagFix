...
1. [high / copy / helmsly]
> The relay never moves; wss://on.slobal.com/tunnel is permanent
> and proxied through Cloudflare.

Wrong: on.slobal.com must stay DNS only. Proxying breaks tenant TLS.
...
Git identity tlaskar-git / taher.laskar@gmail.com. Builds run through
