...
mod tests {
    ...
    fn quote_tag(number: u32, quote: &str) -> Tag {
        Tag {
            ...
            screen_resolution: "2496x1664".into(),
            text: "wrong, it is pinned to the footer".into(),
            severity: "high".into(),
            area: "copy".into(),
    ...
    fn mixed_sweep_round_trips_through_json() {
        ...
        sweep.tags.push(sample_tag(1));
        sweep.tags.push(quote_tag(2, "the save button sits below the fold"));
        ...
        assert_eq!(back.tags[1].quote, "the save button sits below the fold");
    }
